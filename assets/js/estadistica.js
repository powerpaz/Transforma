...
(function () {
  ...
  document.querySelectorAll(".acc-item").forEach((item) => {
    item.addEventListener("click", () => {
      ...
      if (marcoBtn) { marcoBtn.classList.add("is-active"); marcoBtn.setAttribute("aria-selected", "true"); }
      if (panelMarco) panelMarco.classList.add("is-active");
